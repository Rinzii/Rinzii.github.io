(function() {
    ...
    var get = document.querySelector.bind(document),
        ...
        canvas, context, scale, boundary = 25,
        totalVertices = 80,
        maxSpeed = 3,
        vertices = [],
        r, g, b, ri, gi, bi, rotMap = [1, 2, 3, 0],
        nextMap = [0, 3, 2, 1],
        edge, edges = [],
        circumcenters = [],
    ...
    function draw() {
        var vertex, x, y, vx, vy, absVX, absVY, dx, dy, d, angle, ca, sa, a, i = totalVertices;
